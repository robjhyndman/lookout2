gamma_outliers <- function(n1, n2, shape1, shape2, rate1, rate2, bw,
                           shape_zero = TRUE, normalize = TRUE, ...) {
  results <- tibble(outrate = 0, outliers = 0, N = 0,
