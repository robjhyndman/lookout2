...
# leave-one-out kernel density estimate (fast = FALSE), and is run only for
# n <= 10^4 because it needs an n x n distance matrix; "truncated" sums each
# kernel over at most 500 nearest neighbours (fast = TRUE).
