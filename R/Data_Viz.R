...
results_new <- read.csv("Data_Output/For_Paper/Synthetic_Exp_01_gamma_new_lookout.csv")
results_old <- read.csv("Data_Output/For_Paper/Synthetic_Exp_01_gamma_old_lookout.csv")
...
# TASK 02: EXP2 - NORMAL DISTRIBUTION TWO SEPARATE DISTRIBUTIONS
# ------------------------------------------------------------------------------
results_new <- read.csv("Data_Output/For_Paper/Synthetic_Exp_02_normal_new_lookout.csv")
results_old <- read.csv("Data_Output/For_Paper/Synthetic_Exp_02_normal_old_lookout.csv")
...
results_lng <- results |>
  select(method, mean, true_pos_rate, true_neg_rate, false_pos_rate, false_neg_rate) |>
  rename(
    "True Positive Rate" = true_pos_rate,
    "False Positive Rate" = false_pos_rate,
    "False Negative Rate" = false_neg_rate,
...
# Generate random data
X <- rbind(
  data.frame(x = rnorm(n1),
             y = rnorm(n1)),
  data.frame(x = rnorm(n2, mean = mm, sd = 0.2),
...
# TASK 05: EXP5 - COMPARISON WITH OTHER METHODS
# ------------------------------------------------------------------------------
dfl <- read.csv( "Data_Output/For_Paper/Experiment_5_Comparison_with_Other_Methods_Results.csv")
...
# TASK 06: EXP6 - COMPARISON WITH OTHER METHODS
# ------------------------------------------------------------------------------
dfl <- read.csv( "Data_Output/For_Paper/Experiment_6_Comparison_with_Other_Methods_Results.csv")
...
dfl <- read.csv("Data_Output/For_Paper/Experiment_7_Comparison_with_Other_Methods_Results.csv")
dfl[dfl$Algorithm == 'rdos','Algorithm'] <- 'RDOS'
dfl[dfl$Algorithm == 'kdeos','Algorithm'] <- 'KDEOS'
