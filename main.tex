...
The online Appendix contains the proofs of \cref{prop:order} and \cref{cex:fattails}, two further comparisons of the original and modified algorithms, a set of showcase examples, and the details and results of the sensitivity study of \cref{sec:bwablation}. The updated algorithm is implemented in the \texttt{lookout} R package \citep{Rlookout}, available on CRAN at \url{https://CRAN.R-project.org/package=lookout}. Files to reproduce all numerical examples are available at \url{https://github.com/robjhyndman/lookout2}.
