...
\subsection[Gaussian d* to 0]{Gaussian $d_* \rightarrow 0$}
...
\subsection[Exponential d*to 0 but only for percentiles]{Exponential $d_*\to 0$ but only for percentiles}
...
\subsection[nd* to infinity]{$nd_*\to \infty$}
