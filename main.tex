...
\begin{proof}
   ...
   \frac{1}{n (2 \pi)^{p/2}}  \leq & \hat{f}(\bm{x}_j)  \leq \frac{1}{ (2 \pi)^{p/2}} \, , \\
...
\SK{As these values are bounded, we can use the parameter shape\_zero = TRUE. }
...
% ---------------------------------------------------------------------------
\section{Evaluating lookout with other EVT-based anomaly detection methods}\label{sec:compareWithOtherMethods}
% ---------------------------------------------------------------------------
